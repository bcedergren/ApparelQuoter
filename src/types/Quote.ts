export interface Quote {
  ...
  comments?: Comment[] // Comments on the quote
  attachments?: Attachment[] // Attachments to the quote
...
export interface Comment {
  ...
  createdAt: Date // Date when the comment was made
}
...
export interface Attachment {
  ...
  uploadedAt: Date // Date when the file was uploaded
}
